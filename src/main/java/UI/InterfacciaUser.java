                                ...
                                switch (sceltacase2) {
                                    ...
                                    case 15:
                                        ...
                                        if (scelta5 == 1) {
                                            ...
                                            if (messoInServizio.getStatoMezzo() == StatoMezzo.IN_MANUTENZIONE) {
                                                messoInServizio.setStatoMezzo(StatoMezzo.IN_SERVIZIO);
                                                mezzoDao.saveMezzo(messoInServizio);
                                                manutenzioneDAO.deleteManutenzione(manutenzioneDAO.getManutenzioneById(idMan));
                                                System.out.println("Mezzo con ID " + messoInServizio.getId() + " ritornato in servizio");
                                                System.out.println("Manutenzione con ID: " + idMan + " cancellata correttamente.");
                                            } else {
                                                System.out.println("Mezzo con ID " + messoInServizio.getId() + " non trovato in lista. (già in SERVIZIO)");
                                            }
                                        } else {
                                            System.out.println("Operazione non valida! - devi selezionare una tra le opzioni disponibili");
                                        }
